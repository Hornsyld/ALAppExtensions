...
codeunit 1862 "C5 LedTable Migrator"
{
  ...
  begin
    ...
    GLAccDataMigrationFacade.SetLastModifiedDateTime(CREATEDATETIME(C5LedTable.LastChanged, 0T));
    GLAccDataMigrationFacade.SetLastDateModified(C5LedTable.LastChanged);
